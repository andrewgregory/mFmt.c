...
size_t mfmt_render_int(mfmt_token_t *token, intmax_t i, FILE *f);
size_t mfmt_render_uint(mfmt_token_t *token, uintmax_t i, FILE *f);
size_t mfmt_render_str(mfmt_token_t *token, const char *str, FILE *f);
